...
class ResaProjectSupabaseUser extends BaseAuthUser {
  ResaProjectSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> resaProjectSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = ResaProjectSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
