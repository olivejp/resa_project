...
import 'list_club_page_model.dart';
export 'list_club_page_model.dart';

class ListClubPageWidget extends StatefulWidget {
  const ListClubPageWidget({super.key});

  @override
  State<ListClubPageWidget> createState() => _ListClubPageWidgetState();
}

class _ListClubPageWidgetState extends State<ListClubPageWidget> {
  late ListClubPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListClubPageModel());
